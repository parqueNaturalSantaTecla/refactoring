...
class CustomerTest {
	...
	@Test
	void newReleaseRental1DayTest() {
		String movieName = "movieName";
		Movie movie = new MovieBuilder().title(movieName).priceCode(Movie.NEW_RELEASE).build();
		Rental rental = new RentalBuilder().movie(movie).daysRented(1).build();
		String customerName = "customerName";
		Customer customer = new CustomerBuilder().name(customerName).rental(rental).build();
	...
	void rentalTest() {
		...
		Movie regularMovie = new MovieBuilder().title(regularMovieName).priceCode(Movie.REGULAR).build();
		...
		Movie newReleaseMovie = new MovieBuilder().title(newReleaseMovieName).priceCode(Movie.NEW_RELEASE).build();
